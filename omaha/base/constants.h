...
// *** UI constants.                              ***
// ***                                            ***
const COLORREF kTextColor = RGB(0x00, 0x00, 0x00);
...
const COLORREF kProgressBarLightColor = RGB(0x33, 0x73, 0xf6);
const COLORREF kProgressBarDarkColor = RGB(0x33, 0x73, 0xf6);
